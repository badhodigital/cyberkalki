...
const data = [
  {
    ...
    title: `Decades of government and private sector experience. `,
    description: `Cyberkalki Security has a global mission, to safeguard civilization from those trying to disrupt the industrial infrastructure we depend on every day.`,
  ...
  },
  {
    ...
    title: `We are here to protect you and things that matter to you.`,
    description: `Our solutions protect organizations across a range of industries, including power and water utilities, energy, and manufacturing, and are optimized for emerging applications like the Industrial Internet of Things (IIOT).`,
    moreLink: '#explore-more',
    image: tabImage1,
    list: [
    ],
  ...
  {
    id: 3,
    tabTitle: 'Mission & About us',
    title: `We believe in cyberpeace and safety for all `,
    description: `Cyberkalki Security is privately held and headquartered in the Mumbai, India with regional presence around the world, including USA, Europe, Canada, Australia, New Zealand, Asia Pacific & Middle East.`,
    moreLink: '#explore-more',
    image: tabImage1,
    list: [
    ],
